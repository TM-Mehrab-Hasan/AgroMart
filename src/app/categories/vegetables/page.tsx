...
import { Carrot, ArrowLeft, ShoppingCart, Star } from "lucide-react";
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-20 h-20 rounded-full bg-green-100 text-green-800 flex items-center justify-center">
              <Carrot className="h-10 w-10" />
            </div>
          </div>
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Fresh Vegetables</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get the freshest vegetables directly from local farms to your table
          </p>
        </div>
      </section>
